...
lemlib::ControllerSettings lateral_controller(6.7, // proportional gain (kP)
                                              ...
                                              0, // 0 small error range timeout, in milliseconds
                                            3, // 3 large error range, in inches
                                              300, //300 large error range timeout, in milliseconds
                                              10 // 10 maximum acceleration (slew) - smooths out sudden lurches
);
